...
<html lang="en">
 ...
 <style>
  ...
  <ul class="breadcrumb">
      <li><a href="<?php echo U('Admin/Banner/index');?>">Home</a> <span class="divider">/</span></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/Banner/add');?>'"><i class="icon-plus"></i>轮播图</button>
        ...
        <div class="well">
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <!-- <td><a href="<?php echo U('Admin/Config/index','cid='.$item['cid']);?>"><?php echo ($item['name']); ?></a></td> -->
                <!-- <td><img src="/<?php echo ($item['img']); ?>" width="100"></td> -->
                 <td><a href="<?php echo U('Admin/Banner/index','id='.$item['id']);?>"><?php echo ($item['title']); ?></a></td>
                ...
                <td>
                    ...
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/Banner/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
