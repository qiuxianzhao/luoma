  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="<?php echo U('Admin/Article/index');?>">系统设置</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">导航模块</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">轮播图</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">文章管理</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">文章分类</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">产品管理</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">产品分类</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">入驻商</a></li>
            <li ><a href="<?php echo U('Admin/Article/index');?>">管理员</a></li>
        </ul>
    </div>
    <div class="content">
