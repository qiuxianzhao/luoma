...
<div class="header"><h1 class="page-title">文章分类</h1></div>
<ul class="breadcrumb">
...
<div class="container-fluid">
  <div class="row-fluid">
      <div class="btn-toolbar">
        <button class="btn btn-primary" onClick="location='<?php echo U('Artcate/index');?>'"><i class="icon-list"></i> 文章列表</button>
        <div class="btn-group">
        </div>
      </div>
      <div class="well">
