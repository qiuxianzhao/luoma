...
<html lang="en">
  ...
  <link rel="stylesheet" href="/Public/Admin/lib/bootstrap/css/bootstrap.css">
   11      <link rel="stylesheet" href="/Public/Admin/stylesheets/theme.css">
   12      <link rel="stylesheet" href="/Public/Admin/lib/font-awesome/css/font-awesome.css">
        ...
        <div class="block">
            ...
            <div class="block-body">
                <form>
                    ...
                    <input name="verify" type="text" class="logincode" placeholder="验证码" />
              <img src="/Public/Admin/lib/yzm.php" width="128" height="54" class="loginimg" />
