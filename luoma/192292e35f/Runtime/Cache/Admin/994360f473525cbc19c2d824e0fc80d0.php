...
<div class="container-fluid">
	<div class="row-fluid">
			<div class="btn-toolbar">
				<button class="btn btn-primary" onClick="location='<?php echo U('Config/index');?>'"><i class="icon-list"></i>控制</button>
			  <div class="btn-group">
			  </div>
			</div>
			<div class="well">
				<div id="myTabContent" class="tab-content">
				  <div class="tab-pane active in" id="home">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<label>配置</label>
						<input type="text" name="var" value="" class="input-xxlarge">
						<label>提示文本</label>
						<textarea value="text" name="title" rows="3" class="input-xxlarge"></textarea>
						<label>排序</label>
						<input type="text" name="orders" value="0" class="input-xlarge">						
						<label>是否显示</label>
						...
						<label>添加时间</label>
						<input type="text" name="time" value="" class="input-xlarge">								
						<label></label>
