...
<html lang="en">
 ...
 <style>
  ...
  <div class="header"><h1 class="page-title">产品管理列表</h1></div>
  <ul class="breadcrumb">
      <li><a href="<?php echo U('Admin/Product/index');?>">Home</a> <span class="divider">/</span></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/Product/add');?>'"><i class="icon-plus"></i>产品管理</button>
        ...
        <div class="well">
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo U('Admin/Product/index','cid='.$item['cid']);?>"><?php echo ($item['name']); ?></a></td>
                <td><?php echo ($item['name']); ?></td>
                <td><?php echo ($item['en_name']); ?></td>
                ...
                <td>
                    ...
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/Product/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
