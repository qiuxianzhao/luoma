  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="<?php echo U('Admin/Banner/index');?>">轮播图</a></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/Baner/add');?>'"><i class="icon-plus"></i>轮播图</button>
        ...
        <div class="well">
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($item['addtime']</td> <td> <a href="user["html"><i class="icon-pencil"></i></a>
