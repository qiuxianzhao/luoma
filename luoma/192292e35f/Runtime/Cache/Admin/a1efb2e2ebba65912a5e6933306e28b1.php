...
<html lang="en">
  ...
  */
  ...
  <div class="header"><h1 class="page-title">入驻商信息列表</h1></div>
  <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/Join/add');?>'"><i class="icon-plus"></i>新增入驻商信息</button>
        ...
        <div class="well">
            <table class="table">
              ...
              <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($item['is_show']==1?'启用':'禁用'); ?></td>
                <td><?php echo date('Y-m-d H:i:s',$item['addtime']);?></td>
                <td>
                    <a href="user.html"><i class="icon-pencil"></i></a>
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/Join/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
