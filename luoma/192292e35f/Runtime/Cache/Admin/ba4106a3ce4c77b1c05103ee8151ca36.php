...
<html lang="en">
 ...
 <style>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="<?php echo U('Admin/Baner/index');?>">轮播图</a></li>
  ...
  <div class="header"><h1 class="page-title">輪播圖管理</h1></div>
  <ul class="breadcrumb">
      <li><a href="<?php echo U('Admin/Baner/index');?>">Home</a> <span class="divider">/</span></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/Article/add');?>'"><i class="icon-plus"></i>发布文章</button>
            ...
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    ...
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/Baner/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
