...
<div class="header"><h1 class="page-title">查案品添加</h1></div>
<ul class="breadcrumb">
	<li><a href="<?php echo U('Product/Index/Index');?>">Home</a> <span class="divider">/</span></li>
				...
				<div id="myTabContent" class="tab-content">
				  <div class="tab-pane active in" id="home">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<label>产品名称</label>
						<input type="text" name="nanme" value="" class="input-xxlarge">
						<label>产品英文名称</label>
						<input type="text" name="en_nanme" value="" class="input-xxlarge">
						<label>产品描述</label>
						<input type="text" name="desc" value="" class="input-xxlarge">
						<label>产品详情</label>
						<input type="text" name="detail" value="" class="input-xxlarge">
						<label>点击量</label>
						<input type="text" name="click" value="0" class="input-xlarge">						
						<label>是否显示</label>
