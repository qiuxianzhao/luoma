...
<html lang="en">
 ...
 <style>
  ...
  <div class="header"><h1 class="page-title">文章列表</h1></div>
  <ul class="breadcrumb">
        ...
        <div class="well">
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo U('Admin/Article/index','cid='.$item['cid']);?>"><?php echo ($item['name']); ?></a></td>
                ...
                <td>
                    ...
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/Article/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
