...
<html lang="en">
 ...
 <style>
  ...
  <div class="header"><h1 class="page-title">文章分類管理</h1></div>
  <ul class="breadcrumb">
      <li><a href="<?php echo U('Admin/ArtCate/index');?>">Home</a> <span class="divider">/</span></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
          <button class="btn btn-primary" onClick="location='<?php echo U('Admin/ArtCate/add');?>'"><i class="icon-plus"></i>发布文章</button>
          <button class="btn btn-primary"onClick="location='<?php echo U('Admin/ArtCate/adda');?>'"<i class="icon-plus"></i>详情</button>
          <INPUT name="pclog" type="button" value="GO" onClick="location.href='http://localhost/2016-12-02/index.htm'">
            ...
            <table class="table">
              ...
              <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    ...
                    <a href="#myModal" class="del-a" data-href="<?php echo U('Admin/ArtCate/index','del='.$item['id']);?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                </td>
